// Fixture: the service worker that shipped before release v8 (verbatim from
// commit 7d8e608, cache v5; v6 and v7 used the same policy): network-first
// HTML, stale-while-revalidate JS/CSS. e2e/upgrade.mjs serves it as the
// previous release's worker to prove a returning visitor gets a clean page.
